...
public class NewDelegate {
    ...
    @FXML
    protected void create(MouseEvent event) {
        ...
        if (delName.isEmpty()) {
            ...
            try {
                ...
                String delegationName = delegation.getText();
                Delegate del = Client.addNewDelegate(delName, delegationName, comId);
                App.navigate(del.getId());
                closeStage(event);
            } catch (Exception e) {
